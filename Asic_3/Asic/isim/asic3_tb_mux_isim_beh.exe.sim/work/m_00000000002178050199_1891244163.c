...
#endif
static const char *ng0 = "C:/Users/Professional/Desktop/XilinxVerilogAsicSha256/Asic_3/source/control_block.v";
static int ng1[] = {1, 0};
static int ng2[] = {0, 0};
static int ng3[] = {9, 0};
static int ng4[] = {10, 0};
...
LAB27:    xsi_set_current_line(47, ng0);
    ...
    t33 = ((char*)((ng4)));
    memset(t34, 0, 8);
    xsi_vlog_unsigned_mod(t34, 32, t32, 11, t33, 32);
    t35 = ((char*)((ng2)));
    memset(t36, 0, 8);
    t37 = (t34 + 4);
    t38 = (t35 + 4);
...
LAB34:    xsi_set_current_line(48, ng0);
    ...
    t61 = ((char*)((ng1)));
    memset(t62, 0, 8);
    xsi_vlog_unsigned_add(t62, 32, t60, 11, t61, 32);
    t63 = (t0 + 2568);
    xsi_vlogvar_wait_assign_value(t63, t62, 0, 0, 11, 0LL);
    goto LAB36;
...
LAB64:    if (*((unsigned int *)t31) < *((unsigned int *)t32))
        goto LAB62;
...
extern void work_m_00000000002178050199_1891244163_init()
{
	static char *pe[] = {(void *)Always_38_0};
	xsi_register_didat("work_m_00000000002178050199_1891244163", "isim/asic3_tb_mux_isim_beh.exe.sim/work/m_00000000002178050199_1891244163.didat");
